...
"""
	Python GedLib module for the GXLLabel type
	======================
	
	This module allows using C++ library for edit distance between graphs (GedLib) with Python.
...
cdef extern from "src/gedlib_bind_gxl.hpp" namespace "pyged":
